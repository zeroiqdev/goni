...
export default function ProductDetailClient({ product }: ProductDetailClientProps) {
  ...
  return (
    <div className="space-y-16">
      ...
      {/* Trust Banner (Same as home, different colors: #FAF2EA bg, #1B4D3E text/icons) */}
      <section className="bg-[#FAF2EA] py-8 border-y border-[#E9E1D7]/30 -mx-4 sm:-mx-6 md:-mx-8 lg:-mx-12 xl:-mx-16 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16" id="product-trust-banner">
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 sm:gap-12 md:gap-16 lg:gap-24 text-[#1B4D3E] flex-wrap">
